...
MotorsMatrix:add_motor_raw(0, -1.0,  0.7,  1, 1) -- Motor 1
MotorsMatrix:add_motor_raw(1,  0.0, -1.0, -1, 2) -- Motor 2
MotorsMatrix:add_motor_raw(2,  0.0, -1.0,  1, 3) -- Motor 3
MotorsMatrix:add_motor_raw(3,  1.0,  0.7, -1, 4) -- Motor 4

-- Finalize and set frame label
assert(MotorsMatrix:init(4), "Failed to init MotorsMatrix")
motors:set_frame_string("XTI_Aerospace_Kestrel_V2")
